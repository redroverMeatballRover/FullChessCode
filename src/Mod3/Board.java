...
public class Board {
	...
	public void doChess() 
	{
		...
		player.getCurrentBoardAndMakeMove(pieces); //send current board to player and player moves
	}
	...
	public void inCaseOfIllegalMove(ChessPiece[][] sameBoard)
	{
		pieces = sameBoard;
		doChess();
	}
