...
//		generatePieceClass(); //turns elements into piece. 
	...
	public void generatePawnPromotion(int powerUpPawnX, int powerUpPawnY, String blackOrWhitePiece, String pieceChoice, ChessPiece[][] pieces)
	{
		ChessPieceFactory cpf = new ChessPieceFactory();
		ChessPiece piece = cpf.create(pieceChoice, blackOrWhitePiece);
		pieces[powerUpPawnX][powerUpPawnY] = piece; 	
		Board b = new Board();
		try {
