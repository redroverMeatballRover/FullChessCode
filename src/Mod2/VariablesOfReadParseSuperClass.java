...
public class VariablesOfReadParseSuperClass {
	...
	//matchers
	public final Pattern settingPiece = Pattern.compile("(?<piece>q|k|b|p|n|r+)(?<color>l|d)(?<x>\\w)(?<y>\\d)");
	public final Pattern basicMove = Pattern.compile("(?<piece>q|k|b|p|n|r+)(?<color>l|d)(?<position1>\\w\\d) ?(?<position2>\\w\\d)(?<capture>[*])?");
